  ...
  return (
    <Main>
      <Container>
        {/* div of social media */}
        <div>
         <span><span>facebook</span> <span style={{paddingLeft:'20px'}}><i className="bi bi-facebook"></i></span></span> 
         <span><span>instagram</span> <span style={{paddingLeft:'15px'}}><i className="bi bi-instagram"></i></span></span> 
         <span><span>twitter</span> <span style={{paddingLeft:'38px'}}><i className="bi bi-twitter"></i></span></span> 
         <span><span>youtube</span> <span style={{paddingLeft:'27px'}}><i className="bi bi-youtube"></i></span></span> 
        </div>
        {/* div of of contact */}
        <div>
      ...
      <End style={{marginTop:"50px"}}>copyright 2022. eldo agrove limmited. all right reserved.</End>
    </Main>
  )
}
